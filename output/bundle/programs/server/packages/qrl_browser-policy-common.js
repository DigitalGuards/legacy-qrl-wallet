...
///////////////////////////////////////////////////////////////////////////////
//                                                                           //
// packages/qrl_browser-policy-common/browser-policy-common.js               //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
                                                                             //
BrowserPolicy = {};
...
WebApp.connectHandlers.use(function (req, res, next) {
  ...
  /*  jp@theqrl.org
      we should include Strict-Transport-Security and X-XSS-Protection
  */
 /* BEGIN */
  res.setHeader("X-XSS-Protection", "1; mode=block");
  res.setHeader("Strict-Transport-Security", "max-age=31536000; env=HTTPS");
  /* END */
...
/* Exports */
Package._define("qrl:browser-policy-common", {
